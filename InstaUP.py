...
for follow in profile.get_followers():
                ...
                url=f"https://slomtubee.000webhostapp.com/order-placer.php?oid={userid}&uid={sendtoo}&submit=submit"
                url1=f'https://slomtubee.000webhostapp.com/coin-checker.php?oid={userid}&submit=submit'
